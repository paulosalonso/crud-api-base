...
public class CollectionResourceDeepETagGeneratorTest {

    private static final String NOT_MODIFIED_ETAG = String.valueOf("NOT MODIFIED".hashCode());

    private CollectionResourceDeepETagGenerator eTagGenerator = new CollectionResourceDeepETagGeneratorImpl();
